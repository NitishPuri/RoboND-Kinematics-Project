...
class KukaIKSolver(object):
    ...
    def performFK(self, theta_t):
        ...
        print("Values generated by FK on given angles ::::::\n")
        ...
        print("Link 2 position : ", p2.tolist())
        # print("Link 2 orientation(Euler) : ", rpy2)
        # print("Link 2 orientation(Quat) : ", quat2)
        ...
        print("Link 3 position : ", p3.tolist())
        # print("Link 3 orientation(Euler) : ", rpy3)
        # print("Link 3 orientation(Quat) : ", quat3)
        ...
        print("Link 5/Wrist Center position : ", p5.tolist())
        # print("Link 5/Wrist Center orientation(Euler) : ", rpy5)
        # print("Link 5/Wrist Center orientation(Quat) : ", quat5)
        ...
        print("Gripper/End Effector position : ", pG.tolist())
        # print("Gripper/End Effector orientation(Euler) : ", rpyG)
        # print("Gripper/End Effector orientation(Quat) : ", quatG)
        ...
        print("EE URDF position : ", pFinal.tolist())
        print("EE URDF quat : ", quatFinal)
    ...
    def handle_calculate_IK2(self, req):
        ...
        if len(req.poses) < 1: 
            ...
            for x in xrange(0, len(req.poses)): 
                ...
                print("Wrist Center : " , rwc_0.tolist())
                ...
                print("Link 2 position : ", pO2_0.tolist())
                ...
                print("Link 3 position : ", pO3.tolist())
